...
└─────────────────────────────────────────────┘
                  ...
                  SignalR/HTTP
                      ...
                      ▼
┌─────────────────────────────────────────────┐
│     Game Client Library (ConsoleGame)        │
│  ┌──────────────────────────────────────┐  │
...
- All `*Dto.cs` classes in `ConsoleGameModel`
...
- Game rules in `ConsoleGameServer`
...
### Core Abstraction
- `ConsoleGame/Rendering/IGameRenderer.cs`
- `ConsoleGame/Rendering/GameViewState.cs`
- `ConsoleGame/Rendering/WidgetManager.cs`

### Widgets
- `ConsoleGame/Rendering/Widgets/IWidget.cs`
- `ConsoleGame/Rendering/Widgets/CompassWidget.cs`
- `ConsoleGame/Rendering/Widgets/InventoryWidget.cs`

### Themes
- `ConsoleGame/Rendering/Themes/ThemeConfig.cs`
- `ConsoleGame/Rendering/Themes/BuiltInThemes.cs`

### Implementations
- `ConsoleGame/Rendering/SpectreConsoleRenderer.cs` (reference)
- `ConsoleGame/Core/ClientConsoleDungeonGameNew.cs` (integration example)

### Reusable Client Code
- `ConsoleGame/Client/GameClient.cs` ✅ Unreal-ready
- `ConsoleGameModel/*.cs` ✅ All DTOs Unreal-ready
