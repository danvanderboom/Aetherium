...
namespace Aetherium.Test.Games
{
    ...
    public class GameDefinitionRegistryTests
    {
        ...
        public void LoadsAllValidBundlesFromDirectory()
        {
            ...
            // Aphelion Prime (docs/design/h3-sphere-worldgen.md): the spherical sci-fi companion —
            // an H3 planet generated by the sphere-aware terrain generator. Validating cleanly proves
            // the "h3-terrain" generator is discoverable and declares "h3" support.
            Assert.That(ids, Does.Contain("aphelion-h3"));
            Assert.That(registry.TryGet("aphelion-h3", out var aphelionH3), Is.True);
            Assert.That(aphelionH3!.World.Topology, Is.EqualTo("h3"));
            Assert.That(aphelionH3.World.GeneratorType, Is.EqualTo("h3-terrain"));
