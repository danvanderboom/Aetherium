...
namespace ConsoleGame.Test
{
    public class ClientServerCommunicationTests
    {
        ...
        public void GameSession_InitializesWithWorld()
        {
            ...
            Assert.Equal(ConsoleGame.WorldDirection.North, session.Heading);
        }
        ...
        public void GameSession_ComputesPerception()
        {
            // Arrange
            var session = new GameSession("test-connection", new FovDiagnosticWorldBuilder("open_space"));
            session.ViewLocation = new ConsoleGame.Components.WorldLocation(15, 15, 0);
        ...
        public void PerceptionService_IncludesOnlyVisibleTiles()
        {
            ...
            var playerLocation = new ConsoleGame.Components.WorldLocation(10, 10, 0);
            var viewportSize = new Size(42, 22);

            // Act
            var perception = service.ComputePerception(world, playerLocation, ConsoleGame.WorldDirection.North, viewportSize);
        ...
        public void PerceptionDto_ContainsRequiredFields()
        {
            ...
            Assert.True(Enum.IsDefined(typeof(ConsoleGameModel.WorldDirection), perception.PlayerHeading));
        ...
        public void GameSession_MoveUpdatesViewLocation()
        {
            ...
            // Act
            session.MoveView(ConsoleGameModel.RelativeDirection.Forward, 1);
        ...
        public void GameSession_RotateUpdatesHeading()
        {
            // Arrange
            var session = new GameSession("test-connection", new FovDiagnosticWorldBuilder("open_space"));
            session.Heading = ConsoleGame.WorldDirection.North;
        ...
        public void GameSession_RotateCounterclockwise()
        {
            ...
            // Assert
            Assert.Equal(ConsoleGame.WorldDirection.West, session.Heading);
        }
        ...
        {
            // Arrange
            var engineLocation = new ConsoleGame.Components.WorldLocation(10, 20, 5);
        ...
        {
            // Arrange
            var engineDirection = ConsoleGame.WorldDirection.East;

            // Act
            var dto = engineDirection.ToDto();

            // Assert
            Assert.Equal(ConsoleGameModel.WorldDirection.East, dto);
        }
