        ...
        private sealed class SiloConfigurator : ISiloConfigurator
        {
            ...
            public void Configure(ISiloBuilder siloBuilder)
            {
                ...
                siloBuilder.ConfigureServices(services =>
                {
                    ...
                    // Session manager
                    services.AddSingleton<ConsoleGameServer.GameSessionManager>();

                    // No-op HubContext for tests
                    services.AddSingleton<Microsoft.AspNetCore.SignalR.IHubContext<ConsoleGameServer.GameHub>>(sp => new NullHubContext());
                });
            }

            private sealed class NullHubContext : Microsoft.AspNetCore.SignalR.IHubContext<ConsoleGameServer.GameHub>
            {
