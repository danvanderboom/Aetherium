...
// Orleans client connection is managed by UseOrleansClient (the co-hosted client
// connects/disconnects with the host lifecycle in Orleans 9; there is no manual
// IClusterClient.Connect/Close to call).
