...
namespace Aetherium.Unity.Rendering.Water
{
    ...
    /// a point in water winds to +1, a point inside an island winds to 0. Signed
    /// distance is positive inside the coastline and negative outside: the field the
    /// water shader thresholds to draw a smooth curved edge. Pure and scene-free.
    /// </summary>
    public static class RegionField
    {
        /// <summary>True when <paramref name="p"/> is inside the region (in water, not on an island).</summary>
