...
- [~] 3.3 Visual verification (developer, in-Editor): foam hugs the coast, shallows gradient reads, waves animate, depth falloff matches the Tilemap bands — **owed: needs the Unity Editor (see `docs/unity/rounded-terrain-demo.md`)**
