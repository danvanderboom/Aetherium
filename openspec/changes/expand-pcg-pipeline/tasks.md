...
- [x] 1.5 Implement interactive placement pass (keys/locks/puzzles/traps/secrets/destructibles)
- [x] 1.6 Implement narrative constraints intake (quests → constraints → placement guarantees)
- [x] 1.7 Implement validation suite + regeneration policy (connectivity, difficulty curve, access proofs)
- [x] 1.8 Add metrics export + logs + seed debug overlays
- [x] 1.9 Update MapGeneratorRegistry + configs to enable selecting new generators
