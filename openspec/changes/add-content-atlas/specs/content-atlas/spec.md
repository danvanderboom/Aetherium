...
**Verified by:** `Aetherium.Test.ContentAtlas.ContentAtlasTests.MaterialTag_ExposesTypedFields_NotAStringBag`, `.LightSourceTag_ExposesTypedFields`
...
**Verified by:** `Aetherium.Test.ContentAtlas.ContentAtlasTests.SupportsClientVersion_ChecksMajorVersionOnly`, `.SemVer_Parse_RoundTrips`, `.SemVer_Parse_RejectsMalformedInput`
...
**Verified by:** `Aetherium.Test.ContentAtlas.ContentAtlasTests.AddTerrainTag_RejectsDuplicateId`, `.Contains_IsScopedPerCategory`
...
**Verified by:** `Aetherium.Test.ContentAtlas.DefaultContentAtlasCoverageTests.EveryRealTerrainTileType_ResolvesToATerrainTag`, `.TorusWorldBuilder_HasNotGrownNewTerrainTypes_WithoutUpdatingThisTest`
