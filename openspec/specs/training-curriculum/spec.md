# training-curriculum Specification

## Purpose
Defines training curricula: manual JSON curriculum definitions with staged difficulty, automatic curriculum generation from performance analysis, progression tracking via an Orleans grain, and application of stage parameters to world generation.
