...
## Purpose
Defines cross-world meta-progression: tracking a player's discoveries and cross-world quest completions across a cluster to unlock new world-generation templates and parameters.
## Requirements
