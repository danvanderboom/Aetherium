...
namespace Aetherium.Unity.Rounded
{
    ...
    ///
    /// Ported verbatim from the Aetherium.Unity sandbox prototype (proven there); the
    /// only change is the namespace so the shared client package owns the rounding math.
    /// </summary>
